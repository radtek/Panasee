...
#  /LIBPATH:..\..\..\lib\$(INTDIR)  /LIBPATH:..\..\..\lib\  /LIBPATH:..\..\..\bin\$(INTDIR)  /LIBPATH:..\..\..\bin\  /LIBPATH:..\$(INTDIR)  /LIBPATH:..\  /LIBPATH:..\..\ofstd\$(INTDIR)  /LIBPATH:..\..\ofstd\  ofstd.lib  /STACK:10000000 /machine:X86 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib  == libraries linked in 
...
# ADD LINK32 /out:"..\..\..\bin\Release\dcmftest.exe" /implib:..\..\..\bin\Release\dcmftest.lib
...
# ADD LINK32 /out:"..\..\..\bin\Debug\dcmftest.exe" /implib:..\..\..\bin\Debug\dcmftest.lib
# ADD LINK32 /LIBPATH:..\$(IntDir) /LIBPATH:..
# ADD LINK32 /LIBPATH:..\..\ofstd\$(IntDir) /LIBPATH:..\..\ofstd
...
# ADD BASE LINK32 /nologo /subsystem:console /machine:I386 /IGNORE:4089
# ADD LINK32 /nologo /subsystem:console /machine:I386 /IGNORE:4089 /version:0.0
# ADD LINK32 /out:"..\..\..\bin\MinSizeRel\dcmftest.exe" /implib:..\..\..\bin\MinSizeRel\dcmftest.lib
# ADD LINK32 /LIBPATH:..\$(IntDir) /LIBPATH:..
# ADD LINK32 /LIBPATH:..\..\ofstd\$(IntDir) /LIBPATH:..\..\ofstd
...
# ADD LINK32 /out:"..\..\..\bin\RelWithDebInfo\dcmftest.exe" /implib:..\..\..\bin\RelWithDebInfo\dcmftest.lib
# ADD LINK32 /LIBPATH:..\$(IntDir) /LIBPATH:..
# ADD LINK32 /LIBPATH:..\..\ofstd\$(IntDir) /LIBPATH:..\..\ofstd
