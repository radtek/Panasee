...
# ADD LINK32 /out:"..\..\..\bin\Release\dcmgpdir.exe" /implib:..\..\..\bin\Release\dcmgpdir.lib
...
# ADD LINK32 /out:"..\..\..\bin\Debug\dcmgpdir.exe" /implib:..\..\..\bin\Debug\dcmgpdir.lib
# ADD LINK32 /LIBPATH:..\$(IntDir) /LIBPATH:..
# ADD LINK32 /LIBPATH:..\..\ofstd\$(IntDir) /LIBPATH:..\..\ofstd
...
# ADD BASE LINK32 /nologo /subsystem:console /machine:I386 /IGNORE:4089
# ADD LINK32 /nologo /subsystem:console /machine:I386 /IGNORE:4089 /version:0.0
# ADD LINK32 /out:"..\..\..\bin\MinSizeRel\dcmgpdir.exe" /implib:..\..\..\bin\MinSizeRel\dcmgpdir.lib
# ADD LINK32 /LIBPATH:..\$(IntDir) /LIBPATH:..
# ADD LINK32 /LIBPATH:..\..\ofstd\$(IntDir) /LIBPATH:..\..\ofstd
...
# ADD LINK32 /out:"..\..\..\bin\RelWithDebInfo\dcmgpdir.exe" /implib:..\..\..\bin\RelWithDebInfo\dcmgpdir.lib
# ADD LINK32 /LIBPATH:..\$(IntDir) /LIBPATH:..
# ADD LINK32 /LIBPATH:..\..\ofstd\$(IntDir) /LIBPATH:..\..\ofstd
