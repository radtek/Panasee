...
OFCondition
ASC_receiveAssociation(FCBI *pCBI,
					   T_ASC_Network * network,
                       T_ASC_Association ** assoc,
                       long maxReceivePDUSize,
                       void **associatePDU,
                       ...
                       int timeout)
{
    ...
    if (cond.bad()) 
	{
		::PostMessage((HWND)pCBI->hwnd,WM_XBDICOMMSG,STORAGE_FAULT_CREATEASSOCIATIONPARAMETERS,NULL);
		return cond;
	}
    ...
    if (cond.bad()) 
	{
		::PostMessage((HWND)pCBI->hwnd,WM_XBDICOMMSG,STORAGE_FAULT_SETTRANSPORTLAYERTYPE,NULL);
		return cond;
	}
    ...
    *assoc = (T_ASC_Association *) malloc(sizeof(**assoc));
    ...
    cond = DUL_ReceiveAssociationRQ(pCBI,&network->network, block, timeout,
