...
static OFCondition
receiveTransportConnection(FCBI *pCBI,
...
static OFCondition
receiveTransportConnectionTCP(FCBI *pCBI,
							  PRIVATE_NETWORKKEY ** network,
                              DUL_BLOCKOPTIONS block,
                              int timeout,
                              DUL_ASSOCIATESERVICEPARAMETERS * params,
  ...
  int activatePDUStorage)
{
    ...
    cond = receiveTransportConnection(pCBI,network, block, timeout, params, association);
...
receiveTransportConnection(FCBI *pCBI,
                           ...
                           PRIVATE_ASSOCIATIONKEY ** association)
{
  return receiveTransportConnectionTCP(pCBI,network, block, timeout, params, association);
}
    ...
    else
    {
        ...
        else
        {
            ...
            do {
				...
				if(pCBI->bToBeTerm)
				{
					::PostMessage((HWND)pCBI->hwnd,WM_XBDICOMMSG,STORAGE_SERVICE_STOP,NULL);
				
					return DUL_NOASSOCIATIONREQUEST;
					//return ASC_SHUTDOWNAPPLICATION;
					//return makeDcmnetCondition(DULC_ASSOCIATIONREJECTED, OF_error, buf);//DUL_NOASSOCIATIONREQUEST
					//return EC_ApplicationProfileViolated;
				}
