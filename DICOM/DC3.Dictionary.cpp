...
{0x0018,0x8150,'DS',"Exposure Time in mS"},
{0x0018,0x8151,'DS',"X-Ray Tube Current in mA"},
...
{0x0018,0x9195,'FD',"Chemical Shifts Minimum Integration Limit in Hz"},
{0x0018,0x9196,'FD',"Chemical Shifts Maximum Integration Limit in Hz"},
...
{0x0040,0x9211,'US',"Real World Value Last Value Mapped"},
{0x0040,0x9212,'FD',"Real World Value LUT Data"},
{0x0040,0x9216,'US',"Real World Value First Value Mapped"},
...
{0x0060,0x3004,'US',"Histogram First Bin Value"},
{0x0060,0x3006,'US',"Histogram Last Bin Value"},
...
{0x5000,0x200C,'OB',"Audio Sample Data"},
{0x5000,0x200C,'OW',"Audio Sample Data"},
{0x5000,0x200E,'LT',"Audio Comments"},
{0x5000,0x2500,'LO',"Curve Label"},
{0x5000,0x2600,'SQ',"Curve Referenced Overlay Sequence"},
{0x5000,0x2610,'US',"Referenced Overlay Group"},
{0x5000,0x3000,'OB',"Curve Data"},
...
{0x5400,0x0110,'OB',"Channel Minimum Value"},
{0x5400,0x0112,'OB',"Channel Maximum Value"},
{0x5400,0x1004,'US',"Waveform Bits Allocated"},
{0x5400,0x1006,'CS',"Waveform Sample Interpretation"},
{0x5400,0x100A,'OB',"Waveform Padding Value"},
{0x5400,0x1010,'OB',"Waveform Data"},
...
{0x6000,0x3000,'OB',"Overlay Data"},
{0x6000,0x4000,'LT',"Overlay Comments"},
{0x7FE0,0x0000,'UL',"Group Length"},
{0x7FE0,0x0010,'OB',"Pixel Data"},
{0xFFFA,0x0000,'UL',"Group Length"},
{0xFFFA,0xFFFA,'SQ',"Digital Signatures Sequence"},
{0xFFFC,0x0000,'UL',"Group Length"},
{0xFFFC,0xFFFC,'OB',"Data Set Trailing Padding"},
{0xFFFE,0x0000,'UL',"Group Length"},
{0xFFFE,0xE000,'UN',"Item"},
{0xFFFE,0xE00D,'UN',"Item Delimiter"},
{0xFFFE,0xE0DD,'UN',"Sequence Delimiter"}
};
RTC GlobalRTC;