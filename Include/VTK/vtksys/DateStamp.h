...
#define vtksys_DATE_STAMP_STRING_DAY   "26"

/** Version date full string.  The format is "CCYYMMDD".  */
#define vtksys_DATE_STAMP_STRING_FULL  "20100326"

/** Version date formatted string.  The format is "CCYY-MM-DD".  */
#define vtksys_DATE_STAMP_STRING       "2010-03-26"
