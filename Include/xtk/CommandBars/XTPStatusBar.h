...
AFX_INLINE void CXTPStatusBarPane::SetButton(BOOL bButton) {
	m_bButton = bButton;
}
AFX_INLINE BOOL CXTPStatusBarPane::IsButton() const {
	return m_bButton;
}
...
AFX_INLINE BOOL CXTPStatusBarPane::IsChecked() const {
	return ((m_nStyle & SBPS_POPOUT) == SBPS_POPOUT);
}
AFX_INLINE BOOL CXTPStatusBarPane::IsEnabled() const {
