...
public:
	...
	void OffsetShadow(CXTPCommandBar* pCommandBar, CSize szOffset);

private:
	void DestroyShadow(CShadowWnd*);
	CShadowWnd* CreateShadow(BOOL bHoriz, CRect rc, CRect rcExclude, CXTPCommandBar* pCommandBar, BOOL bControlPopup);
