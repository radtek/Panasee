...
public:
	...
	//      Reset_str, Reset_disp
	//-----------------------------------------------------------------------
	const XTP_EDIT_LINECOL& GetNormalStart_str();
	const XTP_EDIT_LINECOL& GetNormalStart_disp();//<COMBINE GetNormalStart_str>
	...
	//      Reset_str, Reset_disp
	//-----------------------------------------------------------------------
	const XTP_EDIT_LINECOL& GetNormalEnd_str();
	const XTP_EDIT_LINECOL& GetNormalEnd_disp();//<COMBINE GetNormalEnd_str>
...
AFX_INLINE const XTP_EDIT_LINECOL& CXTPSyntaxEditSelection::GetNormalStart_str() {
	return selStart_str <= selEnd_str ? selStart_str : selEnd_str;
}
AFX_INLINE const XTP_EDIT_LINECOL& CXTPSyntaxEditSelection::GetNormalEnd_str() {
	return selEnd_str <= selStart_str ? selStart_str : selEnd_str;
}

AFX_INLINE const XTP_EDIT_LINECOL& CXTPSyntaxEditSelection::GetNormalStart_disp() {
	return selStart_disp <= selEnd_disp ? selStart_disp : selEnd_disp;
}
AFX_INLINE const XTP_EDIT_LINECOL& CXTPSyntaxEditSelection::GetNormalEnd_disp() {
