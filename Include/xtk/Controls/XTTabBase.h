...
protected:
	...
	// See Also:
	//     OnSelChange, TCN_XT_SELCHANGE, TCN_XT_SELCHANGING
	//-----------------------------------------------------------------------
	...
	//     your derived class to provide additional functionality.
	// See Also:
	//     OnSelChanging, TCN_XT_SELCHANGE, TCN_XT_SELCHANGING
	//-----------------------------------------------------------------------
...
protected:
	...
	BOOL OnSelchangeImpl(NMHDR* pNMHDR, LRESULT* pResult) {
		return CXTTabExBase::OnSelchange(pNMHDR, pResult);
	}
	BOOL OnSelchangingImpl(NMHDR* pNMHDR, LRESULT* pResult) {
		return CXTTabExBase::OnSelchanging(pNMHDR, pResult);
	}
