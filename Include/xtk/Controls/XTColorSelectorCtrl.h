...
// ----------------------------------------------------------------------
// Summary:
//     XTP_PICK_BUTTON structure is used by the CXTColorSelectorCtrl
...
AFX_INLINE void CXTColorSelectorCtrl::SetColors(XTP_PICK_BUTTON* pColors, int nCount, int nCols) {
...
const DWORD CPS_XT_NOAUTOMATIC     = 0x0010;  //<ALIAS CXTColorSelectorCtrl::Create@CRect@CWnd*@DWORD@COLORREF@COLORREF>
